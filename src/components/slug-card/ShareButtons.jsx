...
const ShareButtons = ({ slug }) => {
  const shareUrl = `${typeof window !== "undefined" ? window.location.origin : ""}/product/${slug}`;

  return (
    <ul role="list" className="mt-4 flex items-center space-x-6">
      <li>
        <FacebookShareButton url={shareUrl}>
          <span className="flex size-6 items-center justify-center text-gray-400 hover:text-gray-500">
