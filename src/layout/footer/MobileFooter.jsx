...
const MobileFooter = ({ globalSetting, categories, categoryError }) => {
  ...
  return (
    <>
      ...
      <footer className="sm:hidden fixed z-30 bottom-0 bg-kachabazar-700 flex items-center justify-between w-full h-16 px-3 sm:px-10 shadow-[0_-4px_12px_rgba(0,0,0,0.1)]">
        <button
          aria-label="Bar"
